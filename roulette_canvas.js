var options = ["임승현", "송명훈", "최용준", "김미리", "노윤호", "조경열", "박승민", "백승규", "박원정", "김동준", "이유원", "김경열", "서승범", "이창민", "손영식", "남기준", "유경동"];
var weights = [10, 10, 1, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10];
var startAngle = 0;
...
var weightsSum = weights.reduce(function add(sum, currValue) { return sum + currValue; }, 0);
